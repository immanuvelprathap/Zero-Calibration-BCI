...
from torch.utils.data import TensorDataset, DataLoader # Added for SWA update
import numpy as np
...
# ==========================================
# 4. SWA TRAINING LOOP WITH AUDIT
# ==========================================
if __name__ == "__main__":
    ...
    # --- PHASE 2: FINE-TUNE WITH SWA AND AUDIT ---
    fine_epochs = 300
    swa_start = 220
    ...
    # --- PHASE 3: SWA RESOLUTION (FIXED) ---
    print("\n🎯 CALCULATING FINAL SWA 95% CENTER...")
    
    # Wrap data in DataLoader for batchnorm update
    ...
    plt.title(f"BCI IV 2a - SWA Audit | Peak Single: {best_acc:.2f}% | Final SWA: {final_swa_acc:.2f}%")
    plt.tight_layout()
    plt.savefig("step34_swa_audit.png")
    print("\n✅ Audit Plot saved as 'step34_swa_audit.png'")
    plt.show()